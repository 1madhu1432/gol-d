...
export const Route = createFileRoute("/bank-pledged-silver")({
  component: BankPledgedSilverPage,
});

function BankPledgedSilverPage() {
  const {
  ...
  const pledgedTransactions = useMemo(() => {
    return filteredTransactions.filter(
      (t) => t.metal === "Silver" && t.type === "Bank Pledged"
    );
  }, [filteredTransactions]);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        eyebrow="Core Operations · Bank Pledged Silver Desk"
        title="Bank-Pledged Silver Redemption & Acquisition"
        ...
        actions={
          <>
            <Button
              ...
              onClick={() => toast.success("Exported Bank Pledged Silver pipeline to CSV")}
            >
            ...
            >
              <Plus className="size-3.5" /> New Bank Pledged Silver
            </Button>
          </>
        }
      />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
        ...
        <div className="border border-border p-3.5 rounded-md bg-card">
          <p className="text-muted-foreground font-semibold">Gross Silver Valuation</p>
          <p className="font-display text-xl font-bold text-primary mt-1">{formatINR(stats.SilverValuationTotal)}</p>
        </div>
        <div className="border border-border p-3.5 rounded-md bg-card">
        ...
        <div className="flex items-center gap-2">
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="Silver Release Pending">Silver Release Pending</SelectItem>
              <SelectItem value="Silver Received">Silver Received</SelectItem>
          ...
          <table className="w-full text-xs">
            <thead className="bg-table-head text-muted-foreground">
              <tr>
                ...
                <th className="px-4 py-3 text-right font-semibold">Gross Silver Value</th>
                ...
                <tr key={t.id} className="hover:bg-muted/40 transition-colors">
                  ...
                  <td className="px-4 py-3 text-right whitespace-nowrap">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      {t.status === "Silver Release Pending" && (
                        <Button
                          size="sm"
            ...
            <div className="space-y-4 text-xs">
              <DialogHeader>
                <DialogTitle className="font-display text-base font-bold">
                  ...
                  {activeActionStep === "release" && "Confirm Silver Release from Bank Strongroom"}
              ...
              {activeActionStep === "bank-pay" && (
                <div className="space-y-2">
                  <p className="text-muted-foreground leading-relaxed">
                    AVP Silver wires the full redemption amount directly to the bank clearing account. Enter bank RTGS reference number to proceed:
                  </p>
              ...
              {activeActionStep === "release" && (
                <div className="space-y-2">
                  <p className="text-muted-foreground leading-relaxed">
                    The bank loan is fully cleared. Authorized AVP Liaison officer visits the bank counter to inspect seals and receive Silver packets.
                  </p>
              ...
              {activeActionStep === "receive" && (
                <p className="text-muted-foreground leading-relaxed">
                  Confirm physical custody arrival of Silver lot at branch intake bay. The metal will be transferred to the XRF testing laboratory.
                </p>
              )}
            ...
            <div className="space-y-4 text-xs">
              <DialogHeader>
                <DialogTitle className="font-display text-base font-bold flex items-center justify-between">
                  <span>Bank Pledged Silver Loan Case · {selectedTxn.id}</span>
              ...
              <div className="border border-border rounded p-3 space-y-2">
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Gross Silver Valuation ({selectedTxn.totalNetWeight}g @ {selectedTxn.averagePurity}%):</span>
